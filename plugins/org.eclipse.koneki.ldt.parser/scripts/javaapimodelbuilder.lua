...
function M._item(_item)
	...
	jitem:setDocumentation(generator.applytemplate(_item))
...
function M._typedef(_typedef)
	...
	if _typedef.tag == "recordtypedef" then
		...
		jtypedef:setDocumentation(generator.applytemplate(_typedef))
...
function M._file(_file)
	...
	jfile:setDocumentation(generator.applytemplate(_file))
